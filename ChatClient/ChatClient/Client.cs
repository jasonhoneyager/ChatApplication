    ...
    public partial class Client : Form
    {
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sendData.ChatMessage = InputMessage.Text.Trim();
        ...
        private void btnConnect_Click(object sender, EventArgs e)
        {
            try
            {
                this.name = InputName.Text.Trim();
                Packet sendData = new Packet();
                sendData.ChatName = this.name;
                sendData.ChatMessage = null;
                sendData.ChatDataIdentifier = DataIdentifier.LogIn;
                this.clientSocket = new Socket(AddressFamily.InterNetwork, SocketType.Dgram, ProtocolType.Udp);
                IPAddress serverIP = IPAddress.Parse(InputServerIP.Text.Trim());
        ...
        {
            ChatWindow.Text += messge + Environment.NewLine;
        }
    }
}
