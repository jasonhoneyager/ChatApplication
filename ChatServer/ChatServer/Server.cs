...
namespace ChatServer
{
    public partial class Server : Form
    {
            ...
            try
            {
                ...
                switch (receivedData.ChatDataIdentifier)
                {
                    ...
                    case DataIdentifier.LogIn:
                        ...
                        sendData.ChatMessage = string.Format("{0} Logged In", receivedData.ChatName);
                        break;
                    ...
                    case DataIdentifier.LogOut:
                        ...
                        sendData.ChatMessage = string.Format("{0} Logged Out", receivedData.ChatName);
                        break;
                }
        ...
        {
            ServerTraffic.Text += status + Environment.NewLine;
        }
    }
}